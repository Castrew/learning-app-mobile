...
with_node \
  ...
  --target "/Users/antongeorgiev/Documents/LearningApp/TestFromGit/learning-app-mobile/ios/Pods/Target Support Files/Pods-learningappmobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-secure-store" "expo-system-ui" "expo-web-browser"
